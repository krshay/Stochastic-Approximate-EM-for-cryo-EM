function [x_updated, A, y] = x_step_parallel_all_in_series(Ls, rotations, ...
...
for nn=1:number_in_series
    ...
    %     pl_rot_curr = load("pl_rot_curr_"+num2str(nn)+".mat");
    %     pl_rot_curr = pl_rot_curr.pl_rot_curr_cell;
    Ipsis_cell = Ipsis_cell_all{nn};
    %     Ipsis_cell = load("Ipsis_cell_all_"+num2str(nn)+".mat");
    %     Ipsis_cell = Ipsis_cell.Ipsis_cell_all_mic;
